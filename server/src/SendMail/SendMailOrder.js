...
const sendMail = async (email) => {
    try {
        ...
        const info = await transport.sendMail({
            ...
            text: 'Cảm ơn bạn đã đặt hàng tại Mộc Xoa!',
            html: `
            <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
                <h2 style="color: #2E86C1;">🎉 Cảm ơn bạn đã đặt hàng tại Mộc Xoa!</h2>
                <p>Xin chào <b>${email}</b>,</p>
                <p>Chúng tôi đã nhận được đơn hàng của bạn và rất vui khi được đồng hành cùng bạn trong trải nghiệm mua sắm tại <b>Mộc Xoa</b>. Đơn hàng của bạn đã được <b>xác nhận thành công</b> và đang được xử lý để chuẩn bị giao đến tay bạn trong thời gian sớm nhất.</p>
                
                <h3 style="color: #28B463;">Bạn có thể theo dõi trạng thái đơn hàng tại đây: http://xoastore.net/info</h3>
                ...
                <p>Nếu bạn có bất kỳ câu hỏi nào, đừng ngần ngại <b><a href="https://www.facebook.com/people/M%E1%BB%99c-Xoa/61589897113612/" style="color: #2980B9;">liên hệ với chúng tôi</a></b>. Đội ngũ Mộc Xoa luôn sẵn sàng hỗ trợ bạn!</p>

                <p> 💖 Cảm ơn bạn đã tin tưởng lựa chọn <b>Mộc Xoa</b>. 
                Sự hài lòng của bạn chính là động lực để chúng tôi không ngừng nâng cao chất lượng sản phẩm và dịch vụ. 
                </p>

                <p style="margin-top:30px; color:#2E86C1; font-weight:bold;"> Trân trọng,<br> Đội ngũ Mộc Xoa </p>
            </div>
            `,
        });
    } catch (error) {
